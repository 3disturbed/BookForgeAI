...
Rules:
- Fix grammar, punctuation, spelling and typography.
- Enforce the design spec's style rules consistently across the chapter.
- Normalise dialogue punctuation, quotation marks, dashes and ellipses.
- Standardise the spelling of names and places against the canonical names list.
